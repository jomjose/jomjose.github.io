...
$(document).ready(function() {
	...
	t.bind('input paste', function() {
		localStorage.setItem("thundernote_t"+$('#files>li.selected').html(), t.html() );
		countwords();
	...
	function selectfile(i) {
		if (!i) {i = 1;}
		t.html( localStorage.getItem("thundernote_t"+i) ).focus();
		localStorage.setItem("thundernote_page", i );
		$('#words').html( t.html().split(/\s+/).length );
	}
	...
	$('#style a').click(function(){
		localStorage.setItem("thundernote_"+$(this).parent().attr('class'), $(this).attr('class') );
		load_styles();
	...
	function load_styles() {
		$('html')
			.removeClass()
			.addClass(localStorage.getItem("thundernote_typography") )
			.addClass(localStorage.getItem("thundernote_size") )
			.addClass(localStorage.getItem("thundernote_color") )
			.addClass(localStorage.getItem("thundernote_background") )
			.addClass(localStorage.getItem("thundernote_width") );
	}
	load_styles();
